...
2. In the player's settings make sure you have ticked off both "Follow the system theme" and "Use light theme". Ticking either one of these on after you have enabled a dark coloured theme may make Dopamine switch to a default option and prevent you from selecting the theme again before you have ticked both selections off and restarted the player.
